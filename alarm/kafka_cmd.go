...
const (
	...
	CmdUpWithExclusionIpAlarm       = "up_with_exclusion_ip_alarm"
	CmdUpMismatchMacIpAlarm         = "up_mismatch_mac_ip_alarm"
	CmdUpNoLeaseIpAlarm             = "up_no_lease_ip_alarm"
	CmdUpReservedUnallocatedIpAlarm = "up_reserved_unallocated_ip_alarm"
)
